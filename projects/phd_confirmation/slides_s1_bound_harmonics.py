...
class S1BoundHarmonicsSlides(Slide):
    ...
    def construct(self):
        ...
        self.slide_pause(nav_progress, 2.25)
        ...
        self.slide_pause(nav_progress, 2.75)
        ...
        self.slide_pause(nav_progress, 3.35)
        ...
        self.slide_pause(nav_progress, 4.15)
